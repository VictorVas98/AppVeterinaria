...
@Entity
@SqlResultSetMapping(
        name = "InformacionCitaMapping",
        classes = @ConstructorResult(
                targetClass = InformacionCitaDeterminada.class,
                columns = {
...
@NamedNativeQuery(
        name = "InformacionCitaDeterminada.findByNumeroCita",
        query = "EXEC InformacionCitaDeterminada :NumeroCita",
        resultSetMapping = "InformacionCitaMapping"
)
public class InformacionCitaDeterminada {
    ...
    public InformacionCitaDeterminada(int numeroCita, String fechaCita, String observaciones, String tipoCita, int codigoEmpleado, String nombreEmpleado, String codigoCliente, String nombreCliente, String nombreMascota, String fechaNacimiento, String servicio) {
    ...
    public InformacionCitaDeterminada() {
